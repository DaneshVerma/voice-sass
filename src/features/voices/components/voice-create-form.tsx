...
function FileDropzone({
  ...
  if (file) {
    return (
      <div className='flex min-h-0 items-center gap-3 rounded-xl border p-4'>
  ...
  return (
    <div
      {...getRootProps()}
      className={cn(
        "flex cursor-pointer flex-col items-center justify-center gap-4 overflow-hidden rounded-2xl border px-6 py-5 transition-colors",
