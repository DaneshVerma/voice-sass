...
const tabTriggerClassName =
  "flex-1 h-full gap-2 bg-transparent rounded-none border-x-0 border-t-0 border-b-px border-b-trasnparent shadow-none data-[state=active]:border-b-foreground group-data-[varient=default]/tabs-list:data-[state=active]:shadow-none";
